...
attribute :user, kind_of: String, required: true, default: 'play'
...
attribute :conf_path, kind_of: String, required: true, default: 'conf/application.conf'
attribute :pid_dir, kind_of: String, required: true, default: '/var/run/play'
